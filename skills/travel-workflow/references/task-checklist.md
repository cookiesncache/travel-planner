...
Use this as a reference when auditing trip tasks. Map existing tasks against these categories to identify genuine gaps. Scale to trip type and traveler context — not every item applies to every trip.

## Trip type scoping

| Trip type | Skip / adjust |
|---|---|
